...
var App = (function () {
  ...
  function leftSidebarInit(){
    console.log("left sidebar initialzied");
    ...
    function toggleSideBar(){
      ...
      button.on("click", function(){
        if( wrapper.hasClass( config.collapsibleSidebarCollapsedClass ) ) {
          ...
          $("li a.active", leftSidebar).parents(".parent").addClass("active open");
          $(".be-scroller", leftSidebar).perfectScrollbar("destroy");
        } else {
          wrapper.addClass( config.collapsibleSidebarCollapsedClass );
          $("li a.active", leftSidebar).parents(".parent").removeClass("open");
          $("li.open", leftSidebar).removeClass("open");
        }
      });
    }
    ...
    if ( isCollapsible() ){
      console.log("isCollabsible is false");
      /*Create sub menu elements*/
        syncSubMenu();
        toggleSideBar();

      if( !openLeftSidebarOnClick ){
        console.log("openleftsidebaronclick is false");
        /*Open sub-menu on hover*/
        firstAnchor.on('mouseover',function( event ){
          console.log("mouseover on firstanchor");
          if( isCollapsed() ) {
    ...
    /*Toggle sidebar on small devices*/
      console.log("before lsToggle event listener");
      console.log("lsToggle");
      console.log(lsToggle);
